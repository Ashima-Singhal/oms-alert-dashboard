...
public class MasterEvents {
	...
	public String toString() {
		return "[account_id=" + account_id + ", account_name=" + account_name + ", condition_id="
				+ condition_id + ", condition_name=" + condition_name + ", current_state=" + current_state
				+ ", details=" + details + ", event_type=" + event_type + ", incident_acknowledge_url="
				+ incident_acknowledge_url + ", incident_id=" + incident_id + ", incident_url=" + incident_url
				+ ", owner=" + owner + ", policy_name=" + policy_name + ", policy_url=" + policy_url + ", runbook_url="
				+ runbook_url + ", severity=" + severity + ", timestamp=" + timestamp + "]";
	}
